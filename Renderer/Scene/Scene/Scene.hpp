...
struct Scene {
    ...
    Base::Primitive::IdType AddPrimitive(Base::Primitive&& primitive);
    Base::Primitive& GetPrimitive(const Base::Primitive::IdType& id);
    const Base::Primitive& GetPrimitive(const Base::Primitive::IdType& id) const;
...
private:
    ...
    Utils::IdGenerator<Base::Primitive::IdType> _primitiveIdGenerator;
    ...
    std::unordered_map<Base::Primitive::IdType, Base::Primitive> _primitives;
